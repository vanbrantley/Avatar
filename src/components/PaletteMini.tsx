...
const PaletteMini = observer((props: IPaletteMiniProps) => {
    ...
    return (
        <div className="flex flex-col items-center cursor-pointer" onClick={() => assignAreaColorsFromPalette(props.hatColor, props.topColor, props.bottomColor, props.shoeColor, props.paletteId)}>
            <div className="h-8 w-8 rounded-none" style={{ backgroundColor: props.hatColor }}></div>
            <div className="h-8 w-8 rounded-none" style={{ backgroundColor: props.topColor }}></div>
            <div className="h-8 w-8 rounded-none" style={{ backgroundColor: props.bottomColor }}></div>
            <div className="h-8 w-8 rounded-none" style={{ backgroundColor: props.shoeColor }}></div>
        </div>
    );
